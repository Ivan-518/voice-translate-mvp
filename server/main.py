...
pipeline = create_default_pipeline(
    ...
    baidu_asr_api_key=settings.baidu_asr_api_key,
    baidu_asr_secret_key=settings.baidu_asr_secret_key,
    baidu_asr_cuid=settings.baidu_asr_cuid,
    baidu_asr_dev_pid=settings.baidu_asr_dev_pid,
    baidu_asr_endpoint=settings.baidu_asr_endpoint,
    ...
    baidu_translate_app_id=settings.baidu_translate_app_id,
    baidu_translate_secret_key=settings.baidu_translate_secret_key,
    baidu_translate_endpoint=settings.baidu_translate_endpoint,
    baidu_translate_timeout=settings.baidu_translate_timeout,
